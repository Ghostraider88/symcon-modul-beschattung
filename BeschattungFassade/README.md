...
* **Rundumbeschattung** ab hoher Außentemperatur: hebt (MyHomeControl-Vorbild) nur die
  Sonnenstand-/Richtungsprüfung auf, nicht die Helligkeitsbedingung – ist es z. B. an
  einem bedeckten Abend zwar noch heiß, aber nicht mehr nennenswert hell, bleibt es bei
  der normalen (dann meist negativen) Entscheidung statt unnötig geschlossen zu halten.
